...
@botMain.slash_command(name="find", description="find femboys", nsfw=True)
async def find(interaction=nextcord.Interaction,
    ...
    tagList.extend(defaultBlacklist)
    tagList.extend(defaultWhitelist)
